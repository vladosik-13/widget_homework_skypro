...
def categorize_transactions(transactions, categories):
    """Функция принимает список словарей с данными о банковских операциях
    и список категорий операций, возвращает словарь с количественными данными по категориям."""
...
# Задаем категории для подсчета
categories = ['Перевод', 'Открытие', 'Оплата']
# Получаем количество операций по категориям
